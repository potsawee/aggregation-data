...
# python llm_judge_chatbot_arena.py --judge_name Open-Orca/Mistral-7B-OpenOrca --output_path outputs/lmsys-chatbot-arena-train/Mistral-7B-OpenOrca.jsonl
# python llm_judge_chatbot_arena.py --judge_name cognitivecomputations/dolphin-2.1-mistral-7b --output_path outputs/lmsys-chatbot-arena-train/dolphin-2.1-mistral-7b.jsonl
# python llm_judge_chatbot_arena.py --judge_name mistralai/Mistral-7B-Instruct-v0.1 --output_path outputs/lmsys-chatbot-arena-train/Mistral-7B-Instruct-v0.1.jsonl
# python llm_judge_chatbot_arena.py --judge_name teknium/OpenHermes-2-Mistral-7B --output_path outputs/lmsys-chatbot-arena-train/OpenHermes-2-Mistral-7B.jsonl
# python llm_judge_chatbot_arena.py --judge_name teknium/OpenHermes-2.5-Mistral-7B --output_path outputs/lmsys-chatbot-arena-train/OpenHermes-2.5-Mistral-7B.jsonl
